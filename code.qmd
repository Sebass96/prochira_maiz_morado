---
title: "Effects of stimulants on the germination and early development of two purple maize (Zea mays L.) varieties"
subtitle: "Plants - MDPI"
author: "Sandy Vilchez-Navarro; Arturo Morales-Pizarro; Henry Morocho-Romero; Ricardo Peña-Castillo; Sebastian Casas-Niño; Gabriela Cárdenas-Huamán; Nery Tirabante-Terrones; Esdwin-Oberti Nuñez-Ticliahuanca; Leslie Diana Velarde-Apaza; Max Ramirez-Rojas; Juancarlos Cruz Luis; Flavio Lozano-Isla"
format:
  html:
    toc: true
    toc-location: left
...
plot %>% 
  ggsave2(plot = ., "plants/Fig-1.eps"
         , units = "cm"
         , width = 24
         , height = 29
         )

knitr::include_graphics("plants/Fig-1.jpg")
```
...
include_graphics("plants/Fig-2.jpg")
```
...
include_graphics("plants/Fig-3.jpg")
```
...
ggsave2(plot = plot, "plants/FigS1.jpg", height = 20, width = 30, units = "cm")

ggsave2(plot = plot, "plants/FigS1.eps", height = 20, width = 30, units = "cm")

knitr::include_graphics("plants/FigS1.jpg")
```
